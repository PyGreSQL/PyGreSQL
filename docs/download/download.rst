...
A **Win32 installer** for various Python versions is available at
  * http://pygresql.org/files/PyGreSQL-5.0.3.win-amd64-py2.6.exe
  * http://pygresql.org/files/PyGreSQL-5.0.3.win-amd64-py2.7.exe
  * http://pygresql.org/files/PyGreSQL-5.0.3.win-amd64-py3.4.exe
  * http://pygresql.org/files/PyGreSQL-5.0.3.win-amd64-py3.5.exe
